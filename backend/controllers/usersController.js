      ...
      if (emailExists) {
        ...
        if(role === "admin"){
          ...
          while(true){
            ...
            const codeExists = await User.findOne({"userInfo.classCode": classCode})
          ...
          const codeExists = await User.findOne({"role": "teacher", "userInfo.classCode": userInfo.classCode})
