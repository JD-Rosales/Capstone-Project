...
const AdminFingerSpell = () => {
  ...
  return (
    <div className="admin-finger-spell">
      ...
      {deleteModal ? (
        <DeleteModal
          ...
          API_URL={BASE_URL + `/api/fingerspell/${id}`}
...
export default AdminFingerSpell;
