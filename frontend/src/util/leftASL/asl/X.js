...
//Thumb
x.addCurl(Finger.Thumb, FingerCurl.HalfCurl, 3.0);
x.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 3.0); 

//Index
x.addCurl(Finger.Index, FingerCurl.NoCurl, 3.0);
x.addDirection(Finger.Index, FingerDirection.DiagonalUpRight, 3.1);
