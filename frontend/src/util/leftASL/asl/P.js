...
//Thumb
p.addCurl(Finger.Thumb, FingerCurl.NoCurl, 1.5);
p.addDirection(Finger.Thumb, FingerDirection.DiagonalDownRight, 2.0); 

//Index
p.addCurl(Finger.Index, FingerCurl.NoCurl, 1.8);
p.addDirection(Finger.Index, FingerDirection.DiagonalDownRight, 2.0);
