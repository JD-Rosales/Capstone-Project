...
//Thumb
l.addCurl(Finger.Thumb, FingerCurl.NoCurl, 1.5);
l.addDirection(Finger.Thumb, FingerDirection.HorizontalRight, 1.5); 

//Index
l.addCurl(Finger.Index, FingerCurl.NoCurl, 1.5);
l.addDirection(Finger.Index, FingerDirection.VerticalUp, 1.5);
