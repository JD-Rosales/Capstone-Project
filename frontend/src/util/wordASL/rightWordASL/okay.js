...
okay.addDirection(Finger.Middle, FingerDirection.DiagonalUpLeft, 1.0);

//Ring
okay.addCurl(Finger.Ring, FingerCurl.FullCurl, 1.0);
okay.addDirection(Finger.Ring, FingerDirection.DiagonalUpLeft, 1.0);

//Pinky
okay.addCurl(Finger.Pinky, FingerCurl.NoCurl, 1.0);
okay.addDirection(Finger.Pinky, FingerDirection.HorizontalLeft, 1.0);