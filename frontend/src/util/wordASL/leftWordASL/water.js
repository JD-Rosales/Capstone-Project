...
water.addDirection(Finger.Index, FingerDirection.DiagonalUpRight, 1.0);

//Middle
water.addCurl(Finger.Middle, FingerCurl.NoCurl, 1.0);
water.addDirection(Finger.Middle, FingerDirection.DiagonalUpRight, 1.0); 

//Ring
water.addCurl(Finger.Ring, FingerCurl.NoCurl, 1.0);
water.addDirection(Finger.Ring, FingerDirection.DiagonalUpRight, 1.0);

//Pinky
water.addCurl(Finger.Pinky, FingerCurl.FullCurl, 1.0);
water.addDirection(Finger.Pinky, FingerDirection.DiagonalUpRight, 1.0);